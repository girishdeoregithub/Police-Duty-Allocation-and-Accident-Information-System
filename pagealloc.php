...
<td id="rty"><input type="text" name=alno size="44" onkeypress="return nval(event);" value=<?php echo $orn;?>></td>
</tr>
<tr>
<td id="rty">Pid :</td>
<td id="rty"><select name="id">
                <?php
                $cn=mysql_connect("localhost","root");
                mysql_select_db("project1",$cn);
...
if($sb=="submit")
{
    if($fl==1)
{
$sql="insert into pagealloc values('$_POST[alno]','$_POST[id]','$_POST[dno]')"; 
mysql_query($sql,$cn); 
...
if($sb=="update")
{
    if($fl==0)
{
$sql="update pagealloc set Pid='$_POST[id]',DutyNo='$_POST[dno]' where AllocationNo='$_POST[alno]'";
mysql_query($sql,$cn);
echo "data updated";
}
}
