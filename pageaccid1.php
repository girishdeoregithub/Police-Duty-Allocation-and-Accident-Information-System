                     ...
                     <div class="header_information">
                        <nav class="navigation navbar navbar-expand-md navbar-dark ">
                           ...
                           <div class="collapse navbar-collapse" id="navbarsExample04">
                              ...
                              <div class="sign_btn"><a href="reports.html">Back</a></div>
                           </div>
                        </nav>
                     </div>
                  </div>
...
<body>
<form name=frm method=post action=pageaccid1.php>
<center><h1>Equipment Booked Information</h1></center>
<tr>
...
echo "<caption>Equipment Information</caption>";
echo "<tr>";
